    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Courses", t => t.CourseID, cascadeDelete: true)
                .ForeignKey("dbo.AspNetUsers", t => t.UploaderID, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        AnonymousPublisher = c.Boolean(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Notifications", "GradeID", "dbo.Grades");
            ...
            DropIndex("dbo.Notifications", new[] { "GradeID" });
